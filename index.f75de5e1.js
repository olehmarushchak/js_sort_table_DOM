/* eslint-disable no-shadow */ /* eslint-disable prettier/prettier */ /* eslint-disable max-len */ "use strict";
const NAME = "Name";
    ...
    header.addEventListener("click", (event)=>{
        switch(event.target.textContent){
            case NAME:
                ...
                break;
            case POSITION:
                const sortedByPosition = staff.sort((a, b)=>a.position.localeCompare(b.position));
                table.forEach((row, index)=>{
            ...
            case AGE:
                ...
                break;
            case SALARY:
                const sortedBySalary = staff.sort((a, b)=>a.salary.slice(1).replace(",", "") - b.salary.slice(1).replace(",", ""));
                table.forEach((row, index)=>{
